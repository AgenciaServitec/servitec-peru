...
createRoot(document.getElementById('root')).render(_jsx(StrictMode, { children: _jsx(ThemeProvider, { theme: theme, children: _jsxs(ConfigProvider, { theme: config, children: [_jsx(GlobalStyle, {}), _jsx(BrowserRouter, { children: _jsx(App, {}) })] }) }) }));
