...
import {} from 'dayjs';
export const DatePicker = ({ value = undefined, name, required = false, disabled = false, hidden = false, error = false, helperText = '', label, variant = 'filled', allowClear = true, onChange, prefix = null, disabledDate = () => false, format = 'DD/MM/YYYY HH:mm', }) => {
