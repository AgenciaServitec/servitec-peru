                  ...
                  <div className="text-sm md:text-base leading-relaxed space-y-4">
                    ...
                    {sec.id === "garantia" && (
                      <div className="space-y-4">
                        ...
                        <p>
                          La garantía estándar de 90 días es otorgada
                          directamente por{" "}
                          <span className="text-white font-medium">
                            SERVITEC PERÚ GROUP E.I.R.L.
                          </span>{" "}
                          y cubre defectos de mano de obra y repuestos
                          instalados por nuestro personal. Dado que somos un
                          servicio técnico multimarca independiente, esta
                          garantía no vincula a los fabricantes originales de
                          los equipos ni afecta las garantías de fábrica que
                          hayan expirado o hayan sido invalidadas por terceros.
                        </p>
                      </div>
                    )}
