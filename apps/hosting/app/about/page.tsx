    ...
    <div>
      <ContentWidth>
        ...
        <p className="max-w-3xl mx-auto">
          ...
          negocios y empresas corporativas. Prestamos nuestros servicios en
          forma altamente personalizada, comprendiendo que cada empresa es
          única, creando una solución a la medida de tus necesidades. Logrando
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-10 px-40 py-2">
          <div className="bg-white p-4 rounded-4xl border-7 border-blue-400 flex flex-col h-full">
            ...
            <p className="text-black">
              ...
              clientes e incrementando el valor del negocio de cada uno de
              ellos.
            </p>
          </div>
          <div className="bg-white p-4 rounded-4xl border-7 border-green-400">
            ...
            <p className="text-black">
              Ser la empresa líder en el mercado brindando soluciones
              innovadoras capaces de satisfacer íntegramente las necesidades de
              nuestros clientes, con la excelencia y calidad del servicio.
            </p>
          </div>
          <div className="bg-white p-4 rounded-4xl border-7 border-red-400">
            ...
            <p className="text-black">
              Nuestros valores son los pilares fundamentales en las relaciones
              con nuestros trabajadores, clientes y proveedores.
            </p>
          </div>
        </div>
      </ContentWidth>
