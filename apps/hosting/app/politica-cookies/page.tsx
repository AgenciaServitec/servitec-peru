              ...
              {secciones.map((sec) => (
                ...
                >
                  ...
                  <div className="text-sm md:text-base leading-relaxed space-y-4">
                    {sec.id === "definicion" && (
                      <p>
                        Las cookies son pequeños archivos de texto que los
                        sitios web envían al navegador y que se almacenan en el
                        terminal del usuario (computadora o dispositivo móvil).
                        Estos archivos permiten que el sitio recuerde
                        información sobre tu visita, lo que puede facilitar tu
                    ...
                    {sec.id === "tipos" && (
                      <>
                        <p>
                          ...
                          Son esenciales para que puedas navegar por la web y
                          usar sus funciones, como el acceso a áreas seguras o
                          el funcionamiento del chat de WhatsApp.
                        </p>
                        <p>
                          <span className="text-white font-medium">
                            Cookies de Análisis:
                          </span>{" "}
                          Nos permiten cuantificar el número de usuarios y
                          realizar la medición y análisis estadístico del uso
                          que hacen los usuarios de nuestra web para mejorar
                          nuestros servicios.
                        </p>
                      </>
                    )}
                    ...
                    {sec.id === "finalidad" && (
                      <p>
                        ...
                        usuario. En ningún caso las cookies que utilizamos
                        recogen datos personales sensibles que puedan
                        identificarte directamente sin tu consentimiento previo.
                      </p>
                    )}
                    ...
                    {sec.id === "gestion" && (
                      <p>
                        ...
                        opciones del navegador instalado en tu computadora o
                        dispositivo móvil. Ten en cuenta que, si bloqueas todas
                        las cookies, es posible que algunas funciones de la web
                        de{" "}
                        <span className="text-white font-medium">
