    ...
    <div className="pb-10">
      <ContentWidth>
        <div className="bg-black rounded-xl">
          <div className="relative h-max bg-gradient-to-br from-yellow-300/20 to-black border border-gray-800 rounded-xl shadow-2xl p-6 lg:p-8 z-0">
            <div
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              ...
              <form className="w-full lg:max-w-md flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  type="submit"
                  className="h-12 px-8 py-4 font-bold bg-yellow-300"
                >
                  Suscribirme
                </Button>
              </form>
