      ...
      <div className="max-w-[1400px] mx-auto bg-[#EBEBEB] border border-neutral-300/50 p-8 md:p-12 lg:px-16 lg:py-12 rounded-xl shadow-[0_-20px_80px_rgba(0,0,0,0.15)]">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10">
          <div className="flex flex-col gap-4 text-left w-full">
            <h4 className="text-black font-extrabold text-2xl md:text-3xl">
              Tus preferencias de privacidad
            </h4>

            <div className="space-y-4">
              <p className="text-neutral-600 text-sm md:text-base leading-relaxed max-w-4xl">
                En <span className="font-bold text-black">SERVITEC PERU</span>{" "}
          ...
          <div className="flex flex-col gap-3 w-full lg:w-[320px] shrink-0">
            <button
              ...
              className="w-full bg-black hover:bg-neutral-800 text-white py-5 px-8 rounded-xl text-sm font-black uppercase transition-all active:scale-[0.97]"
            >
              Aceptar Todo
            </button>
            ...
            <button
              ...
              className="w-full bg-transparent border-2 border-neutral-400/50 text-neutral-700 py-5 px-8 rounded-xl text-sm font-black uppercase text-center hover:bg-black hover:text-white hover:border-black transition-all"
            >
